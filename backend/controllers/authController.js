...
//       if (managerExists) {
//         return res.status(409).json({ message: "A manager already exists for this branch" });
//       }
//     }

//     // Create a new user and save to the database
//     const newUser = new User({ name, email, employee_id, branch_id, role, password });
//     await newUser.save();
...
//     if (role === "Manager") {
//       return res.json({ message: "Login successful", dashboard: "managerDashboard" });
//     }
//     if (role === "Staff") {
//       return res.json({ message: "Login successful", dashboard: "staffDashboard" });
//     }
//   } catch (err) {
//     console.error(err);
...
//       return res.json({ message: "Superadmin login successful", dashboard: "superAdminDashboard" });
//     } else {
